...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-U7K3N3LL.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-2PGM6JMW.js").then((mod) => ({
          default: mod.App
        })),
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-ZHXXA65I.js");
...
//# sourceMappingURL=chunk-7YP45XG4.js.map
